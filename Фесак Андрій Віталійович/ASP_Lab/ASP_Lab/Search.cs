...
public static class Search
{
    ...
    public static int Linear_Search(List<int> list, int search)
    {
    ...
    public static int Barrier_Search(List<int> list, int search)
    {
        int i = 0;
        while (list[i] != search)
            i++;
    ...
    public static int Binary_Search(List<int> arr, int l, int r, int search)
    {
    ...
    public static int Binary_Search_Modify(List<int> arr, int l, int r, int search)
    {
